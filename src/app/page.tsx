            ...
            >
                ...
                <div className="p-4 max-w-7xl mx-auto relative z-10 w-full pt-20 md:pt-20 flex-grow">
                    <h1 className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                        Gujarat <br/> Innovation System
                    </h1>
                    <p className="mt-4 font-normal text-base text-neutral-300 max-w-lg text-center mx-auto">
                        Gujarat is leading the way in innovation, transforming industries and setting new standards for
                        growth. Discover how this vibrant state is shaping the future with groundbreaking ideas and
                        initiatives
                    </p>
                </div>
                ...
                <WobbleCard
                    ...
                    <div className="max-w-sm">
                        <h2 className="max-w-sm md:max-w-lg  text-left text-balance text-base md:text-xl lg:text-3xl font-semibold tracking-[-0.015em] text-white">
                            Dive into blazing-fast cutting-edge state of the javascript, Learn <h1
                            className="text-blue-300">TypeScrip</h1> today!
                        </h2>
                        <p className="mt-4 max-w-[26rem] text-left  text-base/6 text-neutral-200">
            ...
            <div
                ...
                <div className="max-w-2xl mx-auto p-4">
                    ...
                    <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10">
                        ...
                        to create contents, GIS has got you
                        covered.
                    </p>
                    <input
                        type="text"
                        placeholder="gis@gujaratsih.netlify.app"
                        className="rounded-lg border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-700"
                    />
                </div>
                <div className="flex flex-row items-center justify-center pt-8 mb-10 w-full">
                    <div className="flex flex-col items-center justify-center">
                        <AnimatedTooltip items={people}/>
                        <p className="text-center text-neutral-500 mt-2">Designed & Developed by</p>
                        <p className="text-center text-neutral-200 mt-2">Rounak Dey</p>
                    </div>
                </div>
